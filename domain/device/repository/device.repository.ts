...
// 페이징 디바이스 조회
export async function getDevicesWithPaging(page: number, limit: number): Promise<{ items: Device[]; total: number }> {
...
// 디바이스 생성
export async function createDevice(data: Omit<Device, 'created_at'>): Promise<Device> {
